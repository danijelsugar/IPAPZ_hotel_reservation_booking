 ...
 */
final class Version20190318112102 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE review ADD room_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_794381C654177093 ON review');
        $this->addSql('ALTER TABLE review DROP room_id');
    }
}
